...
namespace CultureExtractor.Migrations
{
    ...
    [Migration("20251104052030_AddTagExternalIdMappingTable")]
    partial class AddTagExternalIdMappingTable
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("CultureExtractor.PerformerExternalIdEntity", b =>
                {
                    ...
                    b.HasIndex("TargetSystemUuid", "ExternalId")
                        .IsUnique()
                        .HasDatabaseName("ix_performer_external_ids_target_system_uuid_external_id");
            ...
            modelBuilder.Entity("CultureExtractor.ReleaseExternalIdEntity", b =>
                {
                    ...
                    b.HasIndex("ReleaseUuid", "TargetSystemUuid")
                        .IsUnique()
                        .HasDatabaseName("ix_release_external_ids_release_uuid_target_system_uuid");

                    b.HasIndex("TargetSystemUuid", "ExternalId")
                        .IsUnique()
                        .HasDatabaseName("ix_release_external_ids_target_system_uuid_external_id");
            ...
            modelBuilder.Entity("CultureExtractor.SiteExternalIdEntity", b =>
                {
                    ...
                    b.HasIndex("TargetSystemUuid", "ExternalId")
                        .IsUnique()
                        .HasDatabaseName("ix_site_external_ids_target_system_uuid_external_id");
            ...
            modelBuilder.Entity("CultureExtractor.SubSiteExternalIdEntity", b =>
                {
                    ...
                    b.HasIndex("TargetSystemUuid", "ExternalId")
                        .IsUnique()
                        .HasDatabaseName("ix_sub_site_external_ids_target_system_uuid_external_id");
            ...
            modelBuilder.Entity("CultureExtractor.TagExternalIdEntity", b =>
                {
                    ...
                    b.HasIndex("TargetSystemUuid", "ExternalId")
                        .IsUnique()
                        .HasDatabaseName("ix_tag_external_ids_target_system_uuid_external_id");
            ...
            modelBuilder.Entity("CultureExtractor.PerformerExternalIdEntity", b =>
                {
                    b.HasOne("CultureExtractor.SitePerformerEntity", "Performer")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_performer_external_ids_performers_performer_temp_id");
                    ...
                    b.HasOne("CultureExtractor.TargetSystemEntity", "TargetSystem")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_performer_external_ids_target_systems_target_system_temp_id");
            ...
            modelBuilder.Entity("CultureExtractor.ReleaseExternalIdEntity", b =>
                {
                    b.HasOne("CultureExtractor.ReleaseEntity", "Release")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_release_external_ids_releases_release_temp_id1");
                    ...
                    b.HasOne("CultureExtractor.TargetSystemEntity", "TargetSystem")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_release_external_ids_target_systems_target_system_temp_id1");
            ...
            modelBuilder.Entity("CultureExtractor.SiteExternalIdEntity", b =>
                {
                    b.HasOne("CultureExtractor.SiteEntity", "Site")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_site_external_ids_sites_site_temp_id2");
                    ...
                    b.HasOne("CultureExtractor.TargetSystemEntity", "TargetSystem")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_site_external_ids_target_systems_target_system_temp_id2");
            ...
            modelBuilder.Entity("CultureExtractor.SubSiteExternalIdEntity", b =>
                {
                    b.HasOne("CultureExtractor.SubSiteEntity", "SubSite")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_sub_site_external_ids_sub_sites_sub_site_temp_id1");
                    ...
                    b.HasOne("CultureExtractor.TargetSystemEntity", "TargetSystem")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_sub_site_external_ids_target_systems_target_system_temp_id3");
            ...
            modelBuilder.Entity("CultureExtractor.TagExternalIdEntity", b =>
                {
                    b.HasOne("CultureExtractor.SiteTagEntity", "Tag")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_tag_external_ids_tags_tag_temp_id");
                    ...
                    b.HasOne("CultureExtractor.TargetSystemEntity", "TargetSystem")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_tag_external_ids_target_systems_target_system_temp_id4");
