...
class Program
{
    static void Main(string[] args)
    {
        ...
        */
        ...
        // /*
        // TODO: is casting to BaseOptions causing specialized options not to be used?
...
public class SiteOptions : BaseOptions
{
    ...
    [Option("order", Required = false, HelpText = "Process releases in order (Ascending, Descending)")]
